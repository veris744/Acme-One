...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		<acme:menu-option code="master.menu.anonymous" access="isAnonymous()">
			...
			<acme:menu-suboption code="master.menu.anonymous.favourite-link-Iván" action="https://ev.us.es/"/>
		</acme:menu-option>
		...
		<acme:menu-option code="master.menu.provider" access="hasRole('Provider')">
			...
			<acme:menu-suboption code="master.menu.provider.favourite-link-Iván" action="https://ev.us.es/"/>
		</acme:menu-option>
		...
		<acme:menu-option code="master.menu.consumer" access="hasRole('Consumer')">
			...
			<acme:menu-suboption code="master.menu.consumer.favourite-link-Iván" action="https://ev.us.es/"/>
		</acme:menu-option>
	</acme:menu-left>
